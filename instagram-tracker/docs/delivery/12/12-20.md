...
|-----------|------------|-------------|-----------|---------|------|
| 2025-01-25 11:30:00 | Created | N/A | Proposed | Task file created for architecture consolidation | AI Agent |
| 2025-01-25 11:35:00 | Status Update | Proposed | InProgress | Starting implementation of architecture consolidation | AI Agent |
...
### Frontend Files
- `src/components/CentralContentRegistry.tsx` - Add new tabs and integrate functionality
- `src/components/CampaignPools/CampaignPoolsPage.tsx` → `CampaignPoolsTab.tsx` - Convert to tab component
- `src/components/HighlightGroups/HighlightGroupsPage.tsx` → `HighlightGroupsTab.tsx` - Convert to tab component  
- `src/pages/GanttPage.tsx` → `src/components/Timeline/TimelineTab.tsx` - Convert to tab component
- `src/App.tsx` - Remove separate routes
- `src/components/Layout.tsx` - Update navigation structure

### Upload Flow Enhancement
- `src/components/CentralContentUploadModal.tsx` - Add content type selection
- `src/components/CampaignPools/SprintCreationWizard.tsx` - Enhance with upload flow integration
- `src/components/HighlightGroups/HighlightGroupCreationWizard.tsx` - Enhance with upload flow integration

### Backend Integration (if needed)
- Review API endpoints to ensure proper `is_highlight_group` filtering
- Update any routes that need Content Registry context awareness
