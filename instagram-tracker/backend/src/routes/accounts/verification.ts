 ...
 * GET /api/accounts/verification/pending
 */
 ...
 * POST /api/accounts/verification/:id/approve
 */
router.post('/:id/approve', async (req: any, res: any) => {
    try {
        ...
        // Update account as verified valid and move to next lifecycle state
        const updateQuery = `
            UPDATE accounts 
 ...
 * POST /api/accounts/verification/:id/reject
 */
router.post('/:id/reject', async (req: any, res: any) => {
    try {
        ...
        // Update account as verified invalid and mark as invalid
        const updateQuery = `
            UPDATE accounts 
...
/**
 * Serve verification screenshot
 * GET /api/accounts/verification/:id/screenshot
 */
router.get('/:id/screenshot', async (req: any, res: any) => {
    try {
        const accountId = parseInt(req.params.id);
        ...
        // Construct full path (screenshots are stored relative to bot directory)
 ...
 * PUT /api/accounts/:id/verification
 */
router.put('/:id', async (req: any, res: any) => {
    try {
        ...
        const { 
            ...
            verification_screenshot_timestamp,
 ...
 * GET /api/accounts/verification/stats
 */
